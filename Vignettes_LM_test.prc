...
if capJ lt 3;
        "ERROR: too few categories for estimation (3 minimum). # is";;capJ;stop;
endif;
...
if check gt 1.00001 or check lt (1-0.00001);
        errorlog "ORDERED PROBIT PROBABILITIES DON'T SUM TO 1: AVERAGE PROB IS";check;stop;
endif;
...
elseif exp_mu eq 1;
    ...
    if LR_Yes_No ge 1;
        ...
        ?;"max abs average gradient";;maxc(meanc(abs(HOPIT_grad)));?;
		...
		if ismiss(eye(rows(bhhh_anal)) / bhhh_anal); 
            ...
            if print_it eq 1;
                ...
                ?;"average score        ";;meanc(abs(sumc(score_anal)));
                "LM_test                ";;LM_test;?;
		...
		if ismiss(eye(rows(bhhh_anal_VE)) / bhhh_anal_VE);
            ...
            if print_it eq 1;
                ...
                ?;"average score VE         ";;meanc(abs(score_anal_VE));
                "LM_test_VE                 ";;LM_test_VE;?;
		...
		if ismiss(eye(rows(bhhh_anal_RC)) / bhhh_anal_RC); 
            ...
            if print_it eq 1;
                ...
                ?;"average score RC         ";;meanc(abs(score_anal_RC));
                "LM_test_RC                 ";;LM_test_RC;?;    
        ...
        if cond_Y_N eq 1;
            ...
            if abs(LM_test[1,3]) le 0.05;
                ...
                if cond(chol_bhhh) ge 1500;
                    ...
                    "LM_test (post conditioning)";;LM_test;?;
            ...
            if abs(LM_test_VE[1,3]) le 0.05;
                ...
                if cond(chol_bhhh_VE) ge 1200;
                    ...
                    "LM_test VE (post conditioning)";;LM_test_VE;?;
            ...
            if abs(LM_test_RC[1,3]) le 0.05;
                ...
                if cond(chol_bhhh_RC) ge 5000;
                    ...
                    "LM_test RC (post conditioning)";;LM_test_RC;?;
...
local grad_g4a, grad_g4b, grad_g4V1a, grad_g4V1b, grad_g4V2a, grad_g4V2b, grad_g4V3a, grad_g4V3b;	
    ...
    if flt(minc(vec(p_ijV1)), 0);
		"minc(vec(p_ijV1))";;minc(vec(p_ijV1));stop;
	endif;	
	...
	if kv ge 2;
        ...
        if flt(minc(vec(p_ijV2)), 0);
            "minc(vec(p_ijV2))";;minc(vec(p_ijV2));stop;
        endif;	
		...
		if kv ge 3;
            ...
            if flt(minc(vec(p_ijV3)), 0);
                "minc(vec(p_ijV3))";;minc(vec(p_ijV3));stop;
            endif;	
    ...
    if flt(minc(vec(p_ij)), 0);
		"minc(vec(p_ij))";;minc(vec(p_ij));stop;
	endif;	
