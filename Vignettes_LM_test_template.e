...
#include "e:\Mark\Gauss\procs\Vignettes_LM_test.prc";

/* LOAD RAW DATA AND NAME VARIABELS */

infile = "e:\\mark\\data\\Vignettes\\Share_Gauss_inc";
...
if exp_mu eq 1;
    output file = "e:\Mark\Gauss\Output\Vignettes\Perachi_J4_ammended_exp_V3.out" reset;
else;
     output file = "e:\Mark\Gauss\Output\Vignettes\Perachi_J4_linear_exp.out" reset;
endif;
